...
import Graphs.java.StronglyConnectedComponent.Edge;

public class ArticulationPointTangentAlgorithm {
/*A vertex in an undirected conected graph is an articulation point(or cut vertex) if removing it 
 * (and edges through it) increases the connected components of graph.
